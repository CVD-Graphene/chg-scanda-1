class ACTIONS_NAMES:
    ...
    TURBO_MOLECULAR_PUMP_TURN_ON = 'TURBO_MOLECULAR_PUMP_TURN_ON'
    TURBO_MOLECULAR_PUMP_TURN_OFF = 'TURBO_MOLECULAR_PUMP_TURN_OFF'
    TURBO_MOLECULAR_PUMP_VALVE_OPEN = 'TURBO_MOLECULAR_PUMP_VALVE_OPEN'
    TURBO_MOLECULAR_PUMP_VALVE_CLOSE = 'TURBO_MOLECULAR_PUMP_VALVE_CLOSE'
    TURBO_MOLECULAR_PUMP_SET_TARGET_SPEED = 'TURBO_MOLECULAR_PUMP_SET_TARGET_SPEED'
    TURBO_MOLECULAR_PUMP_WAIT_STOP_WORKING = 'TURBO_MOLECULAR_PUMP_WAIT_STOP_WORKING'
...
class TABLE_ACTIONS_NAMES:
    ...
    TURBO_MOLECULAR_PUMP_TURN_ON = 'Включить турбомолекулярный насос'
    TURBO_MOLECULAR_PUMP_TURN_OFF = 'Выключить турбомолекулярный насос'
    TURBO_MOLECULAR_PUMP_VALVE_OPEN = 'Открыть клапан турбика'
    TURBO_MOLECULAR_PUMP_VALVE_CLOSE = 'Закрыть клапан турбика'
    TURBO_MOLECULAR_PUMP_SET_TARGET_SPEED = 'Установить скорость турбика'
    TURBO_MOLECULAR_PUMP_WAIT_STOP_WORKING = 'Ждать остановки турбика'
